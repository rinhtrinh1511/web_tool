          ...
          <div className="card-wrap">
            ...
            <form action="" className="form-wrap">
              <div className="form-row">
                {renderTextField("Tên đăng nhập", data.username, true, "")}
                {renderTextField("Địa chỉ Email", data.name)}
              </div>
              <div className="form-row">
                {renderTextField("Ngày đăng ký", data.created_at, true, "")}
              ...
              <div className="form-row">
                ...
                {renderTextField("Bạn đang truy cập ở IP", data.ip, true, "")}
              </div>
              <div className="form-row">
                <div className="form-column">
